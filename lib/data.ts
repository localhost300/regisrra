export type Advisor={slug:string;name:string;initials:string;title:string;firm:string;location:string;specialties:string[];services:string[];years:number;rating:number;reviews:number;bio:string;fee:string;minimum:string;fiduciary:boolean;verified:boolean};

export const advisors:Advisor[]=[{
 slug:'jason-edward-salgado',name:'Jason Edward Salgado',initials:'JS',
 title:'Financial Advisor',firm:'Merrill Lynch, Pierce, Fenner & Smith Incorporated',
 location:'New York, NY',specialties:['Investment Advisory','Portfolio Management'],
 services:['Investment Advisory','Portfolio Management','Retirement Planning'],
 years:27,rating:0,reviews:0,
...
export const guides=[
 {slug:'a-calmer-way-to-plan-retirement',category:'Retirement',title:'A calmer way to plan for retirement',excerpt:'Turn a distant ambition into a series of confident, measurable decisions.',time:'7 min read',date:'Aug 28, 2026'},
 {slug:'understanding-advisory-fees',category:'Personal Finance',title:'How financial advisor fees actually work',excerpt:'A plain-language guide to retainers, flat fees, commissions, and AUM pricing.',time:'6 min read',date:'Aug 19, 2026'},
 {slug:'tax-smart-investing',category:'Taxes',title:'The principles of tax-smart investing',excerpt:'Simple moves that can make your portfolio more efficient over time.',time:'8 min read',date:'Aug 8, 2026'},
 {slug:'estate-plan-checklist',category:'Estate Planning',title:'An estate plan you can understand',excerpt:'The core documents and conversations that help protect the people you love.',time:'9 min read',date:'Jul 30, 2026'},
 {slug:'market-volatility',category:'Investing',title:'What to do when markets feel uncertain',excerpt:'A disciplined framework for separating useful action from costly reaction.',time:'5 min read',date:'Jul 22, 2026'},
 {slug:'equity-compensation',category:'Wealth Management',title:'Making sense of equity compensation',excerpt:'A starting point for options, vesting schedules, concentration, and taxes.',time:'10 min read',date:'Jul 14, 2026'}];
